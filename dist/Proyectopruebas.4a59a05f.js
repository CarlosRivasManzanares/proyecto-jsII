...
var _searchViewsJs = require("../js/views/searchViews.js");
...
const recipeView = new (0, _recipeViewJsDefault.default)();
...
const controlSearchResults = async function() {
    try {
        ...
        (0, _resultViewJsDefault.default).renderSpinner(resultsContainer);
        const query = (0, _searchViewsJsDefault.default).getQuery();
        if (!query) {
            console.log("no se ha ingresado informaci\xf3n");
            return;
        }
        await _modelJs.loadSearchResults(query);
        console.log("controlSearch: ", _modelJs.state.search.results);
...
},{"./model.js":"3QBkH","../js/views/RecipeView.js":"dfIpa","../js/views/searchViews.js":"Es71q","../js/views/ResultView.js":"gzics","../js/views/paginationView.js":"7NIiB","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"3QBkH":[function(require,module,exports,__globalThis) {
...
const loadSearchResults = async function name(query) {
    try {
        ...
        state.search.page = 1;
        state.search.resultsPerPage = (0, _configJs.RES_PER_PAGE);
    } catch (err) {
        console.log(`${err} \u{274C}\u{274C}\u{274C}`);
    //throw err;
    }
};
const getSearchResultsPage = function(page = state.search.page) {
    ...
    const resultsPerPage = state.search.resultsPerPage || (0, _configJs.RES_PER_PAGE);
...
console.log("valor de icons:", +(0, _iconsSvgDefault.default));
...
},{"fraction.js":"md6n5","url:../../img/icons.svg":"fd0vu","./view":"2kjY2","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"md6n5":[function(require,module,exports,__globalThis) {
/*
...
},{"url:../../img/icons.svg":"fd0vu","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"Es71q":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class SearchView {
...
//Para que lo que se busque pueda salir en pantalla
...
class PaginationView extends (0, _viewJsDefault.default) {
    ...
    addHandlerClick(handler) {
        this._parentElement.addEventListener('click', function(e) {
            ...
            console.log(goToPage); // para validar que funciona
            handler(goToPage);
        });
    }
    _generateMarkup() {
        ...
        // Escenario 1: Página 1 y más páginas
      ...
      `;
        // Escenario 3: Cualquier página intermedia
...
},{"./view.js":"2kjY2","url:../../img/icons.svg":"fd0vu","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["5DuvQ","7dWZ8"], "7dWZ8", "parcelRequired3ed", {}, "./", "/")

//# sourceMappingURL=Proyectopruebas.4a59a05f.js.map
